...
import airlinebooking.common.enumtype.CustomerBookingStatusType;
...
public class CustomerBooking implements java.io.Serializable {
	...
	@Type(type = "airlinebooking.common.enumtype.GenericEnumUserType", parameters = {
			@Parameter(name = "enumClass", value = "airlinebooking.common.enumtype.CustomerBookingStatusType"),
