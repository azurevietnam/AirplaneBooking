...
import airlinebooking.core.ws.enumtype.CustomerCompanyType;
...
public class CustomerCompany implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6281324119532713005L;
	private Integer id;
	private CustomerBooking customerBooking;
	private CustomerCompanyType customerCompanyType = CustomerCompanyType.ADULT;
	...
	public CustomerCompany(CustomerBooking customerBooking,
			String title, String firstName, String lastName,
			String mobilephone, Date birthDate, CustomerPackage customerPackage,
	...
	@ManyToOne(targetEntity = CustomerBooking.class, cascade=CascadeType.ALL)
	@JoinColumn(name = "customer_booking_id", referencedColumnName = "id")
	public CustomerBooking getCustomerBookingId() {
		return this.customerBooking;
	}

	public void setCustomerBookingId(CustomerBooking customerBooking) {
		this.customerBooking = customerBooking;
	}

	@Column(name = "customer_type")
	public CustomerCompanyType getCustomerCompanyType() {
		return this.customerCompanyType;
	}

	public void setCustomerCompanyType(CustomerCompanyType customerCompanyType) {
	...
	@ManyToOne(targetEntity = CustomerPackage.class, cascade=CascadeType.ALL)
	@JoinColumn(name = "package_id", referencedColumnName = "id")
	public CustomerPackage getCustomerPackageId() {
		return this.customerPackage;
	}

	public void setCustomerPackageId(CustomerPackage customerPackage) {
		this.customerPackage = customerPackage;
	}
