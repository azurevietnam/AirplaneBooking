...
public class TicketStorage implements java.io.Serializable {
	...
	private Integer originParamId;
	private Integer destinationParamId;
	...
	public TicketStorage(Integer airlineType, String flightCode,
			String originCode, String destinationCode, Date fromDate,
			Date toDate, Date fromTime, Date toTime, Integer durationTime,
			String ticketType, Integer originParamId,
			Integer destinationParamId, Integer amount, String createUser,
	...
	@Column(name = "origin_param_id")
	public Integer getOriginParamId() {
		return this.originParamId;
	}

	public void setOriginParamId(Integer originParamId) {
		this.originParamId = originParamId;
	}

	@Column(name = "destination_param_id")
	public Integer getDestinationParamId() {
		return this.destinationParamId;
	}

	public void setDestinationParamId(Integer destinationParamId) {
		this.destinationParamId = destinationParamId;
	}
